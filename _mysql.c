...
/* **********************************************************  */
/* these two method is added by #fyz# to split real query into */
/* two part: send_query,read_query_result                      */
...
"send query to mysql server,but not wait for response";
...
static PyMethodDef _mysql_ConnectionObject_methods[] = {
    ...
    /* these are match declare method to match upper functions #fyz# */
    {
        "send_query",
